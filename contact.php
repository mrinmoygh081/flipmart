...
<div class="body-content">
	...
	<div class="col-md-4 ">
		<form class="register-form" action="post/pst_cntact.php" method = "POST" role="form">
	...
	<div class="col-md-12 outer-bottom-small m-t-20">
		<button type="submit" name = "contact_submit" class="btn-upper btn btn-primary checkout-page-button">Send Message</button>
	</div>
	</form>
</div>
