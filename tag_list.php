                     ...
                     <div class="category-product">
                        <?php
                           if(isset($_GET['tag'])) {
                              ...
                              $query =  "SELECT * FROM tags WHERE tag_name = '$tag' GROUP BY pro_id";
                        ...
                        <?php
                           ...
                           elseif(isset($_GET['man'])) {
                              $man = htmlspecialchars($_GET['man']);
                             $query =  "SELECT * FROM manufacture WHERE man_name = '$man'";
                             $Connection = mysqli_query($db_connection,$query);
                             while($row = mysqli_fetch_assoc($Connection)){
                              $pro_id = $row['pro_id'];
                              $Query = "SELECT * FROM product WHERE pro_id = $pro_id";
...
<?php
                           ...
                           elseif(isset($_GET['color'])) {
                             ...
                             $query =  "SELECT * FROM colors WHERE color_name = '$color'";
                             $Connection = mysqli_query($db_connection,$query);
                             while($row = mysqli_fetch_assoc($Connection)){
                              $pro_id = $row['pro_id'];
                              $Query = "SELECT * FROM product WHERE pro_id = $pro_id";
